...
export function Post({ id, author, publishedAt, content }: PostProps) {
  ...
  const publishedDateFormartted = format(
    publishedAt,
    "d 'de' LLLL 'às' HH:mm'h'",
    { locale: ptBR } // sem o zero somente 1 d, LLLL é o mês por extenso, HH e mm são h e minuto.
    //o que está com aspas simples, é para não ser formatado pelo date fns
  );
